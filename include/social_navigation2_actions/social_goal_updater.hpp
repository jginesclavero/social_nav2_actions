...
class SocialGoalUpdater : public rclcpp_lifecycle::LifecycleNode
{
public:
  ...
  virtual void step() { }
  virtual void getSocialPosesFromAgent(
    std::string id,
    std::vector<geometry_msgs::msg::Pose> & poses) { }
  virtual bool getBestPose(
    std::vector<geometry_msgs::msg::Pose> & poses,
  ...
  void setAgentId(const std::shared_ptr<SetParameters::Request> request,
  ...
  rclcpp::Service<SetParameters>::SharedPtr agent_id_service_;
