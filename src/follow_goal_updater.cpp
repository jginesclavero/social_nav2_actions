...
class FollowGoalUpdater : public social_nav2_actions::SocialGoalUpdater
{
public:
  FollowGoalUpdater(const std::string & node_name)
...
int main(int argc, char ** argv)
{
  ...
  auto node = std::make_shared<social_nav2_actions::FollowGoalUpdater>("follow_goal_updater_node");
